(function () {
	...
	angular
		.module('app')
		.factory('InstructionService', ['$http', 'Upload', InstructionService])
...
function InstructionService ($http, Upload) {
	return {
		get: function () {
			return $http.get('/instructions')
		},
		show: function (request) {
			return $http.get('/instructions/' + request)
		},
		...
		destroy: function (request) {
			return $http.post('/instruction/destroy', request)
		},
		guide: function(request) {
			return $http.get('/instruction/guide/' + request)
		},
		validatingNo: function(request) {
			return $http.post('/instruction/validating/no', request)
		},
		validatingDescription: function(request) {
			return $http.post('/instruction/validating/description', request)
		}
	}
}
